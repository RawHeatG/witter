  ...
  return (
    <div>
      <div className="flex">
        ...
        <div className="flex flex-col justify-center space-y-10 px-16">
          <svg
            className="w-20 h-20"
            fill="currentColor"
            stroke="currentColor"
          ...
          <h1 className="text-7xl font-extrabold pb-6">Happening now</h1>

          <h1 className="text-5xl font-extrabold">
            Join <span className="text-purple">Witter</span> today.
          </h1>
