      ...
      <div className="midbar">
        <section className="px-6 pt-20 pb-6 text-xl border-b border-gray-600">
          ...
          <div className="flex justify-between py-4">
            <div>
              <div className="py-4">
                <h1 className="text-3xl font-bold">Rohit Gulati</h1>
                <h3 className="secondary-text">@rawheatg</h3>
              </div>

              <h3 className="pb-4">
                Hi, I'm jack, jack of all things Web Dev👨‍💻
              </h3>
              ...
              <div className="flex space-x-4">
                <h3 className="secondary-text">
                  <span className="text-text font-bold">624</span> Following
                </h3>
                <h3 className="secondary-text">
                  <span className="text-text font-bold">268</span> Followers
                </h3>
              </div>
            </div>
            <div>
